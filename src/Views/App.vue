            ...
            <section v-else aria-live="polite">
                <div v-for="message in messages" id="message" :key="message.responseId">
                    ...
                    <section v-if="message.queryResult.webhookPayload && message.queryResult.webhookPayload.google">
                        <RichComponent
                                v-for="(component, id) in message.queryResult.webhookPayload.google.richResponse.items"
                                :key="id">
                        ...
                        <RichComponent v-for="(component, id) in message.queryResult.webhookPayload.google.systemIntent"
                                       :key="id">
